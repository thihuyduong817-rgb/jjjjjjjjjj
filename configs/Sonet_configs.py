...
def get_configs():
    ...
    cfg.special_save_folder_name = f'{NUM_L}L_{cfg.exp_or_sim}_transformerUnet_folders_{record_train_valid_name}'
    ...
    cfg.dir_path = "D:\py\ASM_main_result"
    ...
    cfg.result_model_path = "Transformer_UNet_best_epoch.pkl"
